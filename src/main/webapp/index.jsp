...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center">phnpayapplicationdeploymentcomplete</h1>
<h1 style="color: yellow font-size: 40px;" align="center">nexusapplicationdeploymentcomplete</h1>
